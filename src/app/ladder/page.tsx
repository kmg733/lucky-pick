    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="mt-12 grid md:grid-cols-3 gap-6">
        <div className="text-center p-6 bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-950 dark:to-orange-900 rounded-xl">
          ...
          <h3 className="font-semibold text-gray-800 dark:text-orange-200 mb-2">공정한 추첨</h3>
        ...
        <div className="text-center p-6 bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-950 dark:to-orange-900 rounded-xl">
          <div className="text-3xl mb-3">✨</div>
          <h3 className="font-semibold text-gray-800 dark:text-orange-200 mb-2">부드러운 애니메이션</h3>
          <p className="text-sm text-gray-600 dark:text-gray-400">
        ...
        <div className="text-center p-6 bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-950 dark:to-orange-900 rounded-xl">
          <div className="text-3xl mb-3">🎨</div>
          <h3 className="font-semibold text-gray-800 dark:text-orange-200 mb-2">커스터마이징</h3>
          <p className="text-sm text-gray-600 dark:text-gray-400">
