  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-12">
        ...
        <div className="max-w-3xl mx-auto bg-green-50 dark:bg-green-950 border border-green-200 dark:border-green-800 rounded-lg p-4">
          <h2 className="text-sm font-semibold text-green-800 dark:text-green-200 mb-2">💡 사용 방법</h2>
