  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="text-center mb-12">
        ...
        <div className="max-w-2xl mx-auto bg-purple-50 border border-purple-200 rounded-lg p-4 text-left">
          <h3 className="text-sm font-bold text-purple-800 mb-2">📖 사용 방법</h3>
